...
def crossover(parent1,parent2,crossover_type,crossover_rate):
...
def genetic_algorithm(N, population_size, generations, tournament_size, crossover_type,crossover_rate, mutation_rate, mutation_type):
    ...
    for generation in range(1,generations+1):
        ...
        for i in range(population_size//2):
            ...
            child1, child2 = crossover(parent1, parent2, crossover_type,crossover_rate) 
...
def get_user_input():
    ...
    crossover_rate = float(input("Enter the crossover_rate:"))
    mutation_rate = float(input("Enter the mutation_rate:"))
    mutation_type = input("Enter the mutation type(swap/inversion):")

    return N, population_size, generations, tournament_size,crossover_type,crossover_rate, mutation_rate, mutation_type 

#Write the final solution in a notepad
def write_to_textfile(N, population_size,generations,tournament_size,crossover_type,crossover_rate,mutation_rate,mutation_type,solution,generation,runtime):
...
# Get user input
N, population_size, generations, tournament_size, crossover_type, crossover_rate, mutation_rate, mutation_type = get_user_input()

# Run the program and find the runtime
start = time.time()
solution, generation = genetic_algorithm(N, population_size, generations, tournament_size, crossover_type,crossover_rate, mutation_rate, mutation_type)
end = time.time()
runtime = end - start
print("Algorith run time is", runtime,"seconds")

# Write the output to a text file
write_to_textfile(N, population_size, generations,tournament_size,crossover_type,crossover_rate,mutation_rate,mutation_type,solution,generation, runtime)          